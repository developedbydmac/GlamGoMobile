...
export default function CustomerDashboardScreen() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      gradient: ["#E94B8B", "#D63384"] as const,
    },
    {
      title: "Rewards",
      icon: "gift",
      route: "/(customer)/rewards",
      gradient: [Colors.secondary.softGold, "#D4AF37"] as const,
    },
  ];
  ...
  const recentOrders = [
    ...
    {
      id: "2",
      text: "Order #ORD-1235 out for delivery",
      time: "5 hours ago",
      icon: "bicycle",
      color: Colors.secondary.softGold,
    },
    {
      id: "3",
      text: "3 items added to favorites",
      time: "1 day ago",
      icon: "heart",
      color: "#E94B8B",
    },
      ...
      >
        ...
        <View style={styles.section as any}>
          ...
          <View style={styles.chartCard as any}>
            ...
            <Text style={styles.chartSubtext as any}>
              Shop to see recommendations based on your preferences
            </Text>
          </View>
        </View>
      </ScrollView>
