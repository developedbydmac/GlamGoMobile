...
export default function DriverDashboardScreen() {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      gradient: [Colors.semantic.success, "#10B981"] as const,
    },
    {
      title: "Support",
      icon: "help-circle",
  ...
  const recentDeliveries = [
    {
      id: "1",
      text: "Completed delivery to West LA",
      time: "15 min ago",
      icon: "checkmark-circle",
      color: Colors.semantic.success,
    },
    {
      id: "2",
      text: "Earned $15.00 delivery fee",
      time: "15 min ago",
      icon: "cash",
      color: Colors.semantic.success,
    },
    {
      id: "3",
      text: "2 new orders available nearby",
      time: "1 hour ago",
      icon: "notifications",
      color: Colors.secondary.softGold,
    },
      ...
      >
        ...
        <View style={styles.header as any}>
          ...
          <View style={styles.onlineToggleContainer as any}>
            <Text
              style={
                [styles.onlineText, isOnline && styles.onlineTextActive] as any
              }
            >
            ...
            <Switch
              ...
              trackColor={{
                false: Colors.neutral.mediumGrey,
                true: Colors.semantic.success,
              }}
              thumbColor={Colors.neutral.white}
              ios_backgroundColor={Colors.neutral.mediumGrey}
            />
          </View>
        </View>
        ...
        <View style={styles.statsContainer as any}>
          {stats.map((stat, index) => (
            <View
              key={index}
              style={[styles.statCard, { width: cardWidth }] as any}
            >
              <View
                style={
                  [
              ...
              <Text style={[styles.statChange, { color: stat.color }] as any}>
                {stat.change}
              </Text>
            </View>
          ))}
            ...
            {quickActions.map((action, index) => (
              ...
              >
                <LinearGradient
                  ...
                  style={styles.actionGradient as any}
                >
                  <Ionicons
          ...
          <View style={styles.activityContainer as any}>
            {recentDeliveries.map((delivery) => (
              <View key={delivery.id} style={styles.activityItem as any}>
                ...
                >
                  <Ionicons
                    name={delivery.icon as any}
                    size={18}
                    color={delivery.color}
                  />
                </View>
                <View style={styles.activityContent as any}>
                  <Text style={styles.activityText as any}>
                    {delivery.text}
                  </Text>
                  <Text style={styles.activityTime as any}>
                    {delivery.time}
                  </Text>
                </View>
              </View>
        ...
        <View style={styles.section as any}>
          ...
          <View style={styles.mapCard as any}>
            ...
            <Text style={styles.mapSubtext as any}>
              Deliveries available within 5 miles
            </Text>
          </View>
        </View>
      </ScrollView>
